...
import com.satishlabs.service.AvatarService;
...
public class AuthServiceImpl implements AuthService{
	...
	@Override
	public String register(RegisterRequest request, MultipartFile avatar) {
		registrationValidator.validate(request);
		
		String avatarPath = null;
		if(avatar != null && !avatar.isEmpty()) {
			avatarPath = avatarService.saveAvatar(avatar);
		}
